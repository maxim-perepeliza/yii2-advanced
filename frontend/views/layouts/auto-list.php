		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
                                            <li class="active"><a href="/site/auto-list">Catalog cars</a></li>
						...
						<li class="btn-cta"><a href="/about"><span>Our services</span></a></li>
					</ul>	
				</div>
			</div>
		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="/themes/savory/images/img_1.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="/themes/savory/images/img_1.jpg" alt="Image" class="img-responsive">
						</figure>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="/themes/savory/images/img_2.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="/themes/savory/images/img_2.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="/themes/savory/images/img_3.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="/themes/savory/images/img_3.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="/themes/savory/images/img_4.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="/themes/savory/images/img_4.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>Organic Egg</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia..</p>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="/themes/savory/images/img_5.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="/themes/savory/images/img_5.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="/themes/savory/images/img_6.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="/themes/savory/images/img_6.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
